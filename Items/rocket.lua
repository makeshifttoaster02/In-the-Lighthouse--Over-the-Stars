    ...
    local dialogueTree = DialogueTree(
        {
...

            {
                ...
                {"Daniel", "If reincarnation is real, then how many friends did I once know and now lost? How many other mothers and brothers have I forgotten?"},
                {"Daniel", "The idea that all of our history, all of our experiences, all the love we've ever felt are wiped away in our next life as if they were writing on a chalkboard - that's too sad to think about."},
